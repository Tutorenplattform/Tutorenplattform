(function() {
     ...
     * @param {$transitions} $transitions The service used to retrieve information abaout the current state transition
     * from
    ...
    function run($transitions, Authentication) {
         ...
         * @returns {?TargetState} A state retarget result or undefined, if the transition is valid.
         */
